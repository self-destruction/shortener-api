...
// GetCurrentUserParams contains all the bound params for the get current user operation
...
//
// To ensure default values, the struct must have been initialized with NewGetCurrentUserParams() beforehand.
